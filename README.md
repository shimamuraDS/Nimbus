...
WeatherApp 是一款企业级桌面天气提醒应用。该应用长期静默驻留于 Windows 任务栏系统托盘，提供当日及前后 7 天（共计 15 天）的早晚天气、气温与湿度展示。应用采用先进的双重预警触发机制，结合腾讯位置服务的逐小时预报与官方实时灾害预警，在用户设定的特定时间点通过 Windows 原生通知弹窗进行恶劣天气提醒。
